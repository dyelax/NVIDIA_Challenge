...
class AlexNet:
    ...
    def define_graph(self):
        ...
        self.input_frames = tf.placeholder(tf.float32, [None, c.FRAME_SIZE, c.FRAME_SIZE, 3])
        ...
        conv1_in = conv(self.input_frames, conv1W, conv1b, k_h, k_w, c_o, s_h, s_w, padding="SAME", group=1)
    ...
    def get_preds(self, sess, vid_path):
        ...
        with open(csv_path, 'wb') as f:
            ...
            # write header
            writer.writerow(['label_1', 'label_2', 'label_3', 'label_4', 'label_5',
                             'prob_1', 'prob_2', 'prob_3', 'prob_4', 'prob_5'])

        # write output for every batch
        def write_csv_batch(top_5_preds):
            values, labels = top_5_preds
            # subtract 1 from labels to make it 0-indexed.
            data = np.concatenate([c.label_map[labels - 1], values], axis=1)
